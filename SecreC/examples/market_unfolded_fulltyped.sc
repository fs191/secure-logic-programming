...
,relColumn< pd_shared3p,xor_uint32,xor_uint8> >  args )
{
    ...
    ,relColumn< pd_shared3p
    ,xor_uint32
    ,xor_uint8> >  table0 = extend_bargain_bff(args, m, m0, n0);
    ...
    public relColumn< pd_shared3p,xor_uint32,xor_uint8>  X_0 = table0.arg0;
...
void main ()
{
    pd_shared3p xor_uint8 [[1]] x = argument("x");
    public string ds = "DS1";
    tdbOpenConnection(ds);
    public relColumn< pd_shared3p,xor_uint32,xor_uint8>  arg0 = constColumn(x);
    public in_bargain_bff< public
    ...
    public relColumn< pd_shared3p,xor_uint32,xor_uint8>  Z = resUnique1.arg2;

...
,relColumn< public,int32,int32> >  goal_viewESM_ffb_0 ( public string ds
, public in_viewESM_ffb< public,relColumn< public,uint32,uint8> >  args )
{
    ...
    //q1
    public relColumn< public,int32,int32>  X_1 = constColumn(0, m);
    ...
    //q4000
    public bool [[1]] b4000 = bop("==", X_5, table4.arg0);
    ...
    ,relColumn< public,uint32,uint8> 
    ,relColumn< public,int32,int32> >  result;
    result.b = b;
    result.arg0 = X_0;
    result.arg1 = X_1;
    return result;
...
, public in_viewESM_ffb< public,relColumn< public,uint32,uint8> >  args )
{
    ...
    //q3000
    public bool [[1]] b3000 = bop("==", X_4, table3.arg0);
...
T0 getTable_viewESM_ffb (public string ds, public T1 args)
{
    ...
    public out_viewESM_ffb< pd_shared3p
    ,relColumn< public,uint32,uint8> 
    ,relColumn< public,int32,int32> >  result0 = goal_viewESM_ffb_0(ds, args);
    public out_viewESM_ffb< pd_shared3p
    ,relColumn< public,uint32,uint8> 

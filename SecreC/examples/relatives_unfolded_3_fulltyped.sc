...
out_sg_bf< public
,relColumn< pd_shared3p,xor_uint32,xor_uint8> >  goal_sg_bf_0 ( public string ds
, public in_sg_bf< public,relColumn< public,uint32,uint8> >  args )
{
    ...
    //q1
    public relColumn< pd_shared3p,xor_uint32,xor_uint8>  X_1 = X_0;
...
T0 getTable_sg_bf (public string ds, public T1 args)
{
    public T0 result;
    public out_sg_bf< public
    ,relColumn< pd_shared3p,xor_uint32,xor_uint8> >  result0 = goal_sg_bf_0( ds
    , args );
    public out_sg_bf< pd_shared3p
